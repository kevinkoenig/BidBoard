...
var initApp = (function(app) {
     ...
     * usage: initApp.listFilter($(".list"), $("#input-id"));
    ...
    app.listFilter = function (list, input, anchor) {
        ...
        }).keyup( $.debounce(myapp_config.filterDelay, function () {
    ...
    app.saveSettings = function () {
        ...
        if (typeof saveSettings !== "undefined" && $.isFunction(saveSettings) && myapp_config.storeLocally) {
            ...
            if (myapp_config.debugState)
                console.log("Theme settings: " + "\n" +localStorage.getItem("q2c.theme.settings"));
    ...
    app.pushSettings = function (DB_string, saveToLocal) {
        ...
        /* clear localstorage variable "q2c.theme.settings" */
        if (saveToLocal !== false)
            localStorage.setItem("q2c.theme.settings", "");
    ...
    app.domReadyMisc = function() {
        ...
        if (window.Waves && myapp_config.rippleEffect) {
            ...
            window.Waves.attach(".nav-menu:not(.js-waves-off) a, .btn:not(.js-waves-off):not(.btn-switch), .js-waves-on", ["waves-themed"]);
            window.Waves.init();
